...
void Preload::startup()
{
    ...
    game.loader.loadQueue.emplace("Loading textures", [&]() {
        l.loadTextures({
            ...
            { "weapon_hookshot", { "./resources/textures/sprites/weapon_hookshot.png" }},
            ...
            { "hookshot_hook", { "./resources/textures/sprites/hookshot_hook.png" }},
    ...
    game.loader.loadQueue.emplace("Loading JSON data", [&]() {
        ...
        l.loadTileProperties("./resources/tile_properties.json");
        });
    // music and sfx
